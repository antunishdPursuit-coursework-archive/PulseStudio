...
and [Product B](PRODUCT_B_STAFF_SCHEDULING_DASHBOARD.md). Product C and Product
D briefs will be added when their owners are ready to define their increments.
