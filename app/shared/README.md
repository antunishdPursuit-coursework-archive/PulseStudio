...
| [components/README.md](./components/README.md) | The shared components (brand header, logo, sign-in control, the one site footer, alerts) and the clone/rebrand checklist — count the steps on that page, not here; this row said "four-file" until 2026-08-22, when the list already had five, and named three components until 2026-08-23, when there were five |
